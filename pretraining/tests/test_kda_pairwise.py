...
"""Bit-identity and correctness tests for the folded kernel's merged pairwise
pass.
...
on-device gate reruns the full kernel comparison on v5+/v6 hardware where the
MXU accumulates.
"""
